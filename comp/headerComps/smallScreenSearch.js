...
class SmallscreenSearch extends React.Component{
	constructor(){
		super();
		this.state={
	...
	toggleSmallScreenSearch=()=>{		
		/*if (!this.state.SearchBarAndEnter){			
				this.setState({
	...
	render(){return(
		...
		<div className="header__Right__SmallscreenSearch showMe" aria-label="Αναζήτηση">
		<button id="toggleSearch" onClick={()=>this.toggleSmallScreenSearch()}>

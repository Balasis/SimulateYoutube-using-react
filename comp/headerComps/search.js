...
class ButtonPopUpSideMenu extends React.Component{
	...
	render(){return(
<React.Fragment>
	<div className="header__Center__SearchInput" aria-label="Αναζήτηση" tabIndex="-1" onFocus={this.searchFocused} onBlur={this.searchLostFocus}>
			<input type="text" placeholder="Αναζήτηση" />
			<div className="header__Center__SearchInput__Keyboard"></div>
	</div>

	<div className="header__Center__SearchEnter showMe" tabIndex="-1"  aria-label="Αναζήτηση" id="headerSearchEnter">
			<button>
